...
//***************************************************************************
// Funcion llamada cuando se actúa sobre un botón del ratón
//
// el evento manda a la funcion:
// codigo del botón
// estado del botón
...
//***************************************************************************
// Funcion llamada cuando se mueve el ratón
//
// el evento manda a la funcion:
// posicion x del raton
// posicion y del raton
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: Francisco Javier");
   ...
   // asignación de la funcion llamada "funcion_idle" al evento correspondiente
